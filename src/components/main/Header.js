...
function Header({setGoMain, isVisibleHouse }) {
  console.log("heade:",isVisibleHouse)
  return(
    <header className="header">
      <div className="header__main">
        <a className={isVisibleHouse} onClick={setGoMain} ><Home6LineIcon color="#fff" size={28} /></a>
        <div className = "logo">
